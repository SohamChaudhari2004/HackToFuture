...
const How = () => {
  return (
    <div className="bg-blue-500 py-12 flex items-center justify-center m-10 rounded-3xl ">
      <div className="container mx-auto px-3"> {/* Updated padding on both sides */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Step 1 */}
          <div className="bg-blue-400 rounded-lg p-6 shadow-lg text-white">
          ...
          <div className="bg-blue-400 rounded-lg p-6 shadow-lg text-white">
            ...
            <p className="text-sm">
              Pixelcut’s AI image upscaler can enhance images up to 4x the original size. Select your preferred image quality increase amount.
            </p>
          </div>
